                ...
                <div className="pt-10 mx-auto">
                    <div className="lg:grid lg:grid-cols-6 gap-20">
                        <div className="col-span-3">
                            <div className="flex items-center space-x-5">
                                ...
                                <p className="font-semibold text-xl text-white">VALEAKS</p>
                            </div>
                        ...
                        <div className="col-span-1">
                            ...
                            <div>
                                <a href="https://discord.gg/b6VR34c6X5" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Discord Server
                                </a>
                            </div>
                            <div>
                                <a href="https://discord.com/oauth2/authorize?client_id=1272866920156368958" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Invite Bot
                                </a>
                            </div>
                        </div>
                        <div className="col-span-1">
                            ...
                            <div>
                                <Link href="https://discord.gg/b6VR34c6X5">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                            ...
                            <div>
                                <Link href="https://youtube.com/ValorantLeaksTR">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                    ...
                    <div className="mt-10 grid content-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                        <p className="text-white text-center sm:text-left text-opacity-50">
                            {new Date().getFullYear()} &copy; VALORANT Leaks | VALEAKS
                        </p>
                        ...
                        <p className="text-white text-center sm:text-right text-opacity-50">
                            {"We are a community. We don't post content that violates Riot's policies in any way. So if you joined the server for things like “3rd Party Software, Game Bug”, you're in the wrong place."}
                        </p>
                    </div>
                </div>
            </footer>
