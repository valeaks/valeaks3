...
<p>⊳ Every discord server can use the VALEAKS bot for free, it is completely prohibited to sell or market for a fee.</p>
...
<div className="py-3"></div>
<p>⊳ To use certain discord bot commands, you need to vote for the <a className="text-white" href="https://top.gg/">VALEAKS</a> bot at certain intervals.</p>
</div>
    </div>
  );
}
